...
function ParadoxFlowing() {
  return (
    <div className="py-24 space-y-20 px-6">
      ...
      <div className="reading-width mx-auto grid gap-6 sm:grid-cols-2 px-6">
        {mislocalizationContent.columns.map((col, i) => (
          <ScrollAnimate key={col.label} enterFrom={i === 0 ? "left" : "right"}>
            <div className="border border-white/5 p-6">
              <p className="text-xs font-medium uppercase tracking-wide text-gray-500 mb-2">
                {col.label}
              </p>
      ...
      <ScrollAnimate>
        <div className="reading-width mx-auto grid gap-4 sm:grid-cols-2 px-6">
          <div className="border border-white/5 p-4">
            <p className="text-xs font-medium uppercase tracking-wide text-gray-500 mb-2">
              Where cells need iron
            </p>
      ...
      <div className="reading-width mx-auto space-y-2 px-6">
        {trialContent.rows.map((row, i) => (
          <ScrollAnimate key={row.drug} enterFrom="bottom">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 border border-white/5 p-4">
              <div className="sm:w-28 shrink-0">
                <p className="text-sm font-bold text-white">{row.drug}</p>
              </div>
