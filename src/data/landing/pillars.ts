...
export const pillarDeepDives: PillarDeepDive[] = [
  {
    ...
    evidence: "Chelation worsened PD and AD despite reducing brain iron. The problem is distribution, not quantity.",
  ...
  },
  {
    ...
    evidence: "GPX4-KO mice develop ferroptosis specifically in oligodendrocytes, mirroring the white matter damage seen in neurodegeneration.",
  ...
  },
  {
    ...
    evidence: "AQP4-KO increases brain iron (Chen 2024). Export failure causes accumulation even at normal dietary intake.",
